...
public class Pacientes implements Serializable, Cloneable {
    ...
    /** historiaclinica  4  null */
    protected Integer historiaclinica;
    /** dni  4  null */
    ...
    /** 
     * Gets the value for historiaclinica  null
     * null
     */
    ...
    /** 
     * Sets the value for historiaclinica  null
     * null
     */
    ...
    public Object clone() {
        try {
            ...
            o.setHistoriaclinica(new Integer(this.getHistoriaclinica().intValue()));
    ...
    public boolean equals(Object o) {
        ...
        return (
                ...
                compare(this.getHistoriaclinica(), that.getHistoriaclinica()) &&
    ...
    public int hashCode() {
        ...
        result = hash(result, this.getHistoriaclinica());
